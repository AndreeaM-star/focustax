...
export const sisteme: Record<string, SistemData> = {
  ...
  "sme-ss": {
    ...
    titlu: "SMeS",
    emoji: "🏢",
    descriereScurta: "Sistemul de monitorizare electronică a sediilor secundare și punctelor de lucru.",
    culoare: "#6366f1",
    badge: "Înregistrare",
    descriere: "SMeS (Sistemul de Monitorizare electronică a Sediilor Secundare) este platforma prin care se declară înregistrarea, modificarea sau radierea sediilor secundare și punctelor de lucru la ANAF. Înlocuiește procedura clasică la ghișeu.",
    cineEObligat: [
      "Persoanele juridice care înregistrează sedii secundare sau puncte de lucru",
      "PFA cu puncte de lucru diferite față de sediul profesional",
      "Orice contribuabil care deschide, modifică sau închide un punct de lucru",
    ],
    cumFunctioneaza: [
      { pas: "1. Accesezi SMeS prin SPV", descriere: "Intri în contul SPV și accesezi secțiunea dedicată sediilor secundare." },
      { pas: "2. Completezi datele", descriere: "Introduci adresa, activitatea desfășurată, numărul de angajați la punct." },
      { pas: "3. Transmiți declarația", descriere: "Depui electronic — nu mai e necesar drumul la ghișeul ANAF." },
      { pas: "4. Primești confirmarea", descriere: "ANAF confirmă înregistrarea în SPV cu număr de înregistrare." },
    ],
    timeline: [
      { an: "2022", eveniment: "Lansare sistem SMeS electronic" },
      { an: "2023", eveniment: "Obligatoriu pentru persoane juridice" },
    ],
    sanctiuni: [
      "Amendă pentru funcționarea unui punct de lucru nedeclarat: 1.000 – 5.000 lei",
    ],
    linkuriOficiale: [
      { titlu: "SMeS — ANAF", url: "https://www.anaf.ro/anaf/internet/RO/smes" },
    ],
    sfaturi: [
      "Declară sediile secundare înainte de deschidere, nu după",
      "Radierea punctului de lucru trebuie declarată în maxim 30 de zile de la închidere",
    ],
  },
  ...
  "e-filing": {
    ...
    titlu: "e-Filing ANAF",
    emoji: "📁",
    descriereScurta: "Sistemul de depunere electronică a declarațiilor cu certificat digital calificat.",
    culoare: "#10b981",
    badge: "Depunere",
    descriere: "e-Filing este sistemul de depunere electronică a declarațiilor fiscale prin certificate digitale calificate (token USB). Permite depunerea declarațiilor fără autentificare în SPV și este utilizat în special de software-urile contabile pentru integrare automată.",
    cineEObligat: [
      "Contribuabilii care preferă autentificarea cu certificat digital calificat față de user/parolă SPV",
      "Software-urile de contabilitate pentru transmitere automată (API)",
      "Consultanții fiscali care depun pentru mai mulți clienți",
    ],
    cumFunctioneaza: [
      { pas: "1. Obții certificat digital", descriere: "Achiziționezi un certificat digital calificat de la un furnizor acreditat (CertSign, DigiSign, etc.)." },
      { pas: "2. Înregistrezi în SPV", descriere: "Asociezi certificatul cu contul tău SPV pentru depunere electronică." },
      { pas: "3. Pregătești declarația", descriere: "Generezi fișierul XML/PDF din software-ul de contabilitate." },
      { pas: "4. Semnezi și depui", descriere: "Semnezi electronic cu certificatul digital și trimiți declarația în e-Filing." },
    ],
    timeline: [
      { an: "2012", eveniment: "Lansarea sistemului e-Filing pentru depunere cu certificat" },
      { an: "2018", eveniment: "Integrare cu SPV — unificare conturi" },
      { an: "2022", eveniment: "Extindere API pentru software-uri contabile" },
    ],
    sanctiuni: [],
    linkuriOficiale: [
      { titlu: "e-Filing — ANAF", url: "https://efiling.anaf.ro" },
    ],
    sfaturi: [
      "Certificatul digital costă ~100 lei/an și simplifică mult depunerea declarațiilor",
      "Verifică înainte de termen că certificatul nu a expirat",
    ],
  },
