...
function CalculatorSalariu() {
  ...
  function calculeaza() {
    ...
    const cam = b * 0.0225; // contribuția asiguratorie pentru muncă (angajator)
...
function CalculatorFirma() {
  ...
  function calculeaza() {
    ...
    if (tip === "micro") {
      ...
      // sponsorizare: 20% din impozit, max 0.75% CA
    ...
    setRez({ caVal, baza, impozitFirma, profitNet, divVal, impDividende, netDupaDividende });
  }
