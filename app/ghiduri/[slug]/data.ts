...
export const ghiduri: Record<string, GhidData> = {
    ...
    sectiuni: [
      ...
      },
      {
        ...
        continut: [
          ...
          "Nu ești obligat la TVA dacă nu depășești 395.000 lei cifră de afaceri anuală (prag majorat din septembrie 2025).",
        ],
      },
    ],
    timeline: [
    ...
    sectiuni: [
      ...
      },
      {
        ...
        continut: [
          ...
          "SISTEM REAL: Venit net = 120.000 - 15.000 = 105.000 lei. Impozit 10% = 10.500 lei. CAS 25% din min(105.000, 97.200) = 24.300 lei. CASS 10% × 105.000 = 10.500 lei. Total taxe: 45.300 lei.",
          "NORMĂ DE VENIT: Venit impozabil = 55.000 lei. Impozit 10% = 5.500 lei. CAS 25% × 55.000 = 13.750 lei. CASS 10% × 55.000 = 5.500 lei. Total taxe: 24.750 lei.",
          "Concluzie pentru acest exemplu: norma este mai avantajoasă cu ~20.000 lei/an (impozit mai mic pe baza normei inferioare venitului real).",
  ...
  "contributii-sociale": {
    ...
    sectiuni: [
      ...
      },
      {
        ...
        continut: [
          ...
          "Cota CASS: 10% aplicată la baza de calcul = min(venit_net, 60 × SMIN) = min(venit_net, 243.000 lei).",
          "CASS nu este în trepte — se calculează proporțional pe venitul efectiv, plafonat la 243.000 lei (60 × SMIN).",
          "Exemplu: venit net 60.000 lei → CASS = 60.000 × 10% = 6.000 lei. La 250.000 lei → CASS = 243.000 × 10% = 24.300 lei.",
    ...
    chart: {
      ...
      bare: [
        { label: "40.000 lei", value: 8000, color: "#dbeafe" },
        { label: "60.000 lei", value: 27000, color: "#93c5fd" },
        { label: "80.000 lei", value: 36000, color: "#3b82f6" },
        { label: "100.000 lei", value: 44300, color: "#2563eb" },
      ],
    ...
    atentie: [
      "CASS se calculează proporțional pe venitul net, plafonat la 243.000 lei (60 × SMIN) — nu în trepte fixe.",
  ...
  "srl-vs-micro": {
    ...
    culoare: "#059669",
    badgeBg: "#ecfdf5",
    desc: "Ghid complet pentru înțelegerea diferențelor de impozitare între SRL cu impozit pe profit (16%) și microîntreprindere (1% cotă unică din 2026), cu exemple și criterii de alegere.",
    ceFaciAfla: [
      "Condițiile pentru a fi microîntreprindere în 2026",
      "Cota unică 1% — eliminarea cotei de 3% din 2026",
      "Noul plafon: 100.000 EUR/an (≈510.000 lei)",
    ...
    sectiuni: [
      {
        titlu: "Condiții pentru microîntreprindere 2026",
        continut: [
          "Cifra de afaceri ≤ 100.000 EUR/an (≈510.000 lei) — plafon redus de la 500.000 EUR.",
          "Activitățile din domeniu nu interzic regimul micro (bancar, asigurări, jocuri de noroc — excluse).",
          "Nu are capital social deținut de stat sau UAT peste 25%.",
          "Veniturile din consultanță și management nu depășesc 20% din CA totală.",
          "Nu mai este necesară condiția de a avea salariat — condiția era legată de cota 3% care a fost eliminată.",
        ],
      },
      {
        titlu: "Cota unică 1% din 2026",
        continut: [
          "Din 01.01.2026: cotă unică 1% indiferent de numărul de salariați sau structura veniturilor.",
          "Cota de 3% a fost eliminată prin Legea 640/2024.",
          "Exemplu: CA = 200.000 lei → impozit micro = 2.000 lei.",
          "Comparativ cu impozit profit 16%: profit 50.000 lei (marja 25%) → impozit = 8.000 lei. Micro 1% avantajos.",
          "Atenție: dacă CA depășește 100.000 EUR în cursul anului, firma trece obligatoriu la impozit pe profit de la trimestrul următor.",
        ],
      },
      {
      ...
      },
      {
        ...
        continut: [
          "Indiferent de sistemul ales (micro sau profit), dividendele distribuite se impozitează cu 16% (cotă unică din 01.01.2026, urcare de la 8%).",
          "La micro: plătești 1% impozit pe CA (cotă unică din 2026), apoi 16% pe dividende distribuite.",
          "La profit: plătești 16% pe profit, rămâne profitul net, apoi 16% pe dividende.",
    ...
    chart: {
      tip: "bar",
      titlu: "Impozit pe CA 300.000 lei + Dividende 2026 (profit 20%)",
      bare: [
        { label: "Micro 1% (fără div)", value: 3000, color: "#059669" },
        { label: "Micro 1% + Div 16%", value: 12120, color: "#6ee7b7" },
        { label: "Profit 16% + Div 16%", value: 17664, color: "#d97706" },
      ],
      unitate: "lei",
    },
    declaratiiAferente: [
    ...
    sectiuni: [
      ...
      },
      {
        ...
        continut: [
          ...
          "Baza de calcul CASS: venitul net din chirii, plafonat la 243.000 lei (60 × SMIN). Formula: 10% × min(venit_net, 243.000).",
          "Dacă venitul net e sub 24.300 lei/an, nu datorezi CASS.",
          "Exemplu: venit net chirii 35.000 lei → CASS = 35.000 × 10% = 3.500 lei (suma proporțională, nu la plafon fix).",
